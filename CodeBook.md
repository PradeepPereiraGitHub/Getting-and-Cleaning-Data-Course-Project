...
###Step 4:
Now rearrange the above data set by aggregating it on the subject and activity values and getting the mean value across all of them for all selected measurements. Next we order the data set by subject and activity.
